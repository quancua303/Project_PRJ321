<%-- 
    Document   : contact
    Created on : Oct 26, 2020, 4:41:00 PM
    Author     : Acer
--%>
                            ...
                            <div class="right-content">
                                <ul class="list-main">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li><i class="fa fa-user-circle"></i> <a href="#">${name.customerName}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                    <c:choose >
                                        <c:when test = "${name.customerName eq null}">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="single-head">
                                <div class="single-info">
                                    ...
                                    <ul>
                                        <li>+84 869 997 926</li>
                                        <li>+84 862 052 723</li>
                                    </ul>
                                </div>
                                <div class="single-info">
                                    ...
                                    <ul>
                                        <li><a href="mailto:quancua303@gmail.com">quancua303@gmail.com</a></li>
                                        <li><a href="mailto:quannahe140833@fpt.edu.vn">quannahe140833@fpt.edu.vn</a></li>
                                    </ul>
                                </div>
                                <div class="single-info">
