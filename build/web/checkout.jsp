                        ...
                        <div class="checkout-form">
                            ...
                            <form class="form" method="post" action="OrderProduct">
                                <div class="row">
                                    ...
                                    <c:if test="${name.customerName eq null}">
                                        <div class="col-12">
                                ...
                                <div class="single-widget get-button">
                                    <div class="content">
                                        <div class="button">
                                            <button type="submit" style="padding: 10px; font-weight: bold">Done</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="order-details">
                            ...
                            <!--                            <div class="single-widget get-button">
                                                            <div class="content">
                                                                <div class="button">
                                                                    <a href="OrderProduct" class="btn">proceed to checkout</a>
                                                                </div>
                                                            </div>
                                                        </div>-->
                            <!--/ End Button Widget -->
